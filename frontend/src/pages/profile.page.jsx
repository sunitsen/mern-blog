...
const ProfilePage = () => {
  ...
  const fetchUserProfile = () => {
    axios
      .post(import.meta.env.VITE_SERVER_URL + "/get-profile", { username: profileId })
      .then(({ data: user }) => {
    ...
    <AnimationWrapper>
      {loading ? (
        ...
        <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
          <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-1 border-gray md:top-[100px] md:py-10">
            <img
              src={profile_img}
              alt="Profile"
