...
const BlogInteraction = () => {
    ...
    return (
        <>
            <hr className="border-color-gray my-2" />
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-6 items-center">
                    ...
                    <Link to={`https://twitter.com/intent/tweet?text=Read ${title}&url=${location.href}`} className={`w-10 h-10 rounded-full flex items-center justify-center`}>
            ...
            <hr className="border-color-gray mt-2" />
