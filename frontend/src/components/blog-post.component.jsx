...
const BlogPostCard = ({ content, author }) => {
  ...
  return (
    ...
    <div className="w-full">
      ...
      <p className="my-3 text-xl font-gelasio leading-7 max-sm:hidden
         md:max-[1100px]:hidden line-clamp-2">
        {des}
      </p>

      <div className="flex gap-4 mt-7">
        <span className="btn-light py-1 px-4">{tags[0]}</span>
        <span className="ml-3 flex iteam-center gap-2 text-dark-grey">
    ...
    <div className="h-28 aspect-sqaure bg-gray">
